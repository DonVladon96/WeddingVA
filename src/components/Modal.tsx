    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px]">
                <Dialog.Title className='heading-4 text-center font-dancing-script'>Свадебный подарок</Dialog.Title>
                <Dialog.Description className='text-center text-sm md:text-base'>Ваше благословение — очень значимый для нас дар.</Dialog.Description>
                {children}
