        ...
        <section className="container-box2 mt-betweenSectionMd xl:mt-betweenSection">
            ...
            >
                <h3 className="heading-4 md:heading-3 font-dancing-script text-center font-bold px-4 md:px-0">
                    Ваше присутствие лучший подарок, но&nbsp;если вы&nbsp;не&nbsp;можете прийти и&nbsp;все&nbsp;же хотите внести свой вклад в&nbsp;наше будущее, наши реквизиты ниже.
                </h3>
                <Modal open={open} setOpen={setOpen}>
                    ...
                    <Modal.Content>
                        <div className="flex flex-col justify-center items-center pt-8 pb-4 gap-3">
                            <ATM name="Владислав" number="5469680016119812" />
                            <p className="text-gray-500">или</p>
                            <ATM name="Анастасия" number="2202206858059822" />
                        </div>
                    </Modal.Content>
                </Modal>
            </motion.div>
...
function ATM({ name, number }: { name: string, number: string }) {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-3">
            ...
            <p className="font-medium">{`${number} Сбербанк, ${name}`}</p>
