            ...
            <div>
                ...
                <div className="flex justify-start gap-x-2 md:gap-x-4 mt-betweenBoxMd xl:mt-betweenBox px-4 md:px-0">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <motion.h4 className="text-base md:heading-4 font-dancing-script font-bold" {...anim(bluryEffect)}>Встреча</motion.h4>
                        <motion.ul className="space-y-3 md:space-y-4" {...anim(stagger)}>
                            <Li delay={0.2}>
                                <IoCalendarClearOutline className="text-xl md:text-2xl" />
                                <p className="text-xs md:text-base font-roboto-slab">Апрель, 05 2025</p>
                            </Li>
                            <Li delay={0.4}>
                                <BsClock className="text-xl md:text-2xl" />
                                <p className="text-xs md:text-base font-roboto-slab">12:00 регистрация в ЗАГСе по адресу Орджоникидзе, 33а</p>
                            </Li>
                            <Li delay={0.4}>
                                <BsClock className="text-xl md:text-2xl" />
                                <p className="text-xs md:text-base font-roboto-slab">13:30 начало торжества</p>
                            </Li>
                            <Li delay={0.6}>
                                <PiMapPin className="text-2xl md:text-3xl -translate-x-1" />
                                <p className="text-xs md:text-base font-roboto-slab -translate-x-2">
                                    <span className="font-bold">Кафе-Парк Теремок</span>
                                    <br />Кирова, улица Кирова, 10, Ижевск.
                                </p>
                            </Li>
                        </motion.ul>
                    </div>
